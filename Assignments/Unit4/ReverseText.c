// Exercise: print text in reverse order
...
//Example
//Input
//Science Computer on Papers Selected Knuth, Ervin Donald ― correct." be will results the that 
//reader a convince to and works algorithm an way the communicate to concepts, mathematical as 
//well as forms literary and aesthetic traditional with works who essayist an ideally is programmer 
//A clearly. them understand can beings human that so and quickly them perform can machines computing 
